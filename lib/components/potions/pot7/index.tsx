...
export default function Potion7 ({ onClose }: PotionProps){
 

    return(
       <div className="fixed top-0 left-0 w-screen h-screen z-[9999] flex items-center justify-center bg-white flex-col gap-x-9">
            <div className="text-black text-4xl font-bold animate-pulse">
            <Item variant="outline">
                <ItemContent>
                    <ItemHeader className="flex items-center justify-center">
                        Vape of Enlightenment
                    </ItemHeader>
