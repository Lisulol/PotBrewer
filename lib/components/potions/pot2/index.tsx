...
export default function Potion2 ({ onClose }: PotionProps){
            ...
            <Item variant="outline">
                <ItemContent>
                   ...
                   <div className="flex items-center justify-center flex-col">
                    ...
                    <ItemDescription className="max-w-3xs text-center mt-2">Instantly gives you unholy levels of charisma. Side effect: uncontrollable giggling.</ItemDescription>
                    </div>
                </ItemContent>
            </Item>
            </div>
